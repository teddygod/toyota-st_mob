$(document).ready(function(){
  ...
  function makeCustomSelectList (name, selector){
  ...
  makeCustomSelectList ('car_select');
  makeCustomSelectList ('buy-car_model');
  makeCustomSelectList ('car_complect');
  makeCustomSelectList ('department');
  makeCustomSelectList ('marka');
  makeCustomSelectList ('reason');
  for (var i = $('.service .car-item').length - 1; i >= 0; i--) {
    if ( $('#chooseYearModel' + i).length >= 1 ){
      (function(index){
        return (function () {
                  makeCustomSelectList ('model_year', '#chooseYearModel' + index );
                })();
  ...
  $('html, body, .popup-inner').on('click tap', '.option', function(e){
      ...
      $('select[name="'+currSelectField.attr('id')+'"] option').removeAttr('selected').each(function () {  // Set real option to "selected"
          if($(this).html() === $that.html()){
            ...
            $(this).parent().val($(this).html()); // Add value to select
  ...
  $('html, body, .popup-inner').on('click', function(e){
  ...
  $('.table-slider').on('click', function (e) { return; // turned off
  ...
  $('.write-letter').on('click', function(){
    ...
    $('input[name=consultant]').val($.trim(consultName));
